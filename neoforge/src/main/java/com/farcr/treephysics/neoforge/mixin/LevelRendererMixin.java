package com.farcr.treephysics.neoforge.mixin;
...
public class LevelRendererMixin {
    ...
    private void treephysics$playLocalSound(ClientLevel instance, BlockPos pos, SoundEvent soundEvent, SoundSource soundSource, float volume, float pitch, boolean b, Operation<Void> original, @Local BlockState blockstate1) {
